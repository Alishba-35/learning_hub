...
<body>
    ...
    <a href="{{ route('js_content.introduction') }}" class="btn ">Deep Study</a>
</div>
    ...
    <div class="offcanvas offcanvas-start" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1"
        ...
        <div class="offcanvas-body">
            <ul class="list-unstyled">
                ...
                <li><a style="text-decoration:none; color: #e2e8f0;" href="{{ route('js_content.event') }}">Events</a>
                </li>
                <li><a style="text-decoration:none; color: #e2e8f0;" href="{{ route('js_content.class') }}">Class &
                        object</a></li>
                <li><a style="text-decoration:none; color: #e2e8f0;"
                        href="{{ route('js_content.callback') }}">Asynchronous</a></li>
                <li><a style="text-decoration:none; color: #e2e8f0;" href="{{ route('js_content.last') }}">Fetch API</a>
                </li>
            </ul>
        </div>
    </div>
